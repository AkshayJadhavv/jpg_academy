...
const testimonials = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1494790108755-2616b612b1e0?w=200&q=80',
    rating: 5,
  },
  {
    name: 'Rahul Patil',
      ...
      <div ref={ref} className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  ...
                  <div className="flex-shrink-0">
                    <div className="relative">
                      ...
                      {/* Gold ring */}
                      <div className="absolute -inset-1 rounded-full border border-gold/20 -z-10" />
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-body text-lg md:text-xl text-white/80 leading-relaxed mt-4 italic">
        ...
        <div className="hidden md:grid grid-cols-5 gap-3 mt-10">
          {testimonials.map((t, i) => (
            ...
            >
              <img src={t.img} alt={t.name} className="w-9 h-9 rounded-full object-cover mx-auto mb-2" />
              <p className="font-sans text-[10px] text-white/60 truncate">{t.name}</p>
            </motion.button>
          ))}
        </div>
      </div>
